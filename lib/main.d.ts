...
declare const _default: {
    new (options?: ApiConfig | undefined): {
         ...
         */
        getDeliveries(summary?: boolean, filter?: DeliveryStatus[]): Promise<Delivery[]>;
        /**
         ...
         */
        sendRequest<TRequestData = never, TResponseData = AxiosResponse<TRequestData>>(method: Method, path: string, data?: Object | null, includePicnicHeaders?: boolean, isImageRequest?: boolean): Promise<TResponseData>;
        /**
