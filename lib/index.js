...
module.exports = (_a = class PicnicClient extends http_client_1.default {
        /**
     ...
     */
    _a.CheckoutIssueError = checkout_error_1.CheckoutIssueError,
    _a.isCheckoutIssueError = checkout_error_1.isCheckoutIssueError,
    /** Error thrown when a page is served in a different format (Fusion or RSC) than the method expects. */
    _a.UnexpectedPageFormatError = page_format_error_1.UnexpectedPageFormatError,
    _a.isUnexpectedPageFormatError = page_format_error_1.isUnexpectedPageFormatError,
    _a);
