...
class RecipeService {
    ...
    async getRecipe(recipeId) {
        let details = (0, helpers_1.extractRecipeDetails)(recipeId, await this.getRecipeDetailsPage(recipeId));
        if (details.portions > 0 && details.displayedPortions !== details.portions) {
            ...
            details = (0, helpers_1.normalizeRecipeQuantities)(details, wrapper);
        }
        ...
        for (const ingredient of details.ingredients) {
            ...
            if (!names.has(ingredient.sellingUnitId)) {
                ...
                names.set(ingredient.sellingUnitId, (0, helpers_1.extractIngredientProductName)(productPage));
            }
