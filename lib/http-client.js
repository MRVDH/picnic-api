...
class HttpClient {
     ...
     */
    async sendRequest(method, path, data = null, includePicnicHeaders = false, isImageRequest = false, contentType) {
        ...
        const body = data === null ? null : isRawBody ? data : JSON.stringify(data);
