...
export type FusionEventPayload = FusionToastEventPayload | FusionSnackbarEventPayload | FusionRefreshEventPayload | { type: string; [key: string]: any };
...
export type FusionPressAction =
  | FusionOpenAction
  | FusionEventAction
  | FusionEndpointAction
  | FusionCallbackAction
  | FusionReloadAction
  | FusionAnalyticsAction
  | { actionType: string; [key: string]: any };

// ── PML inner components (inside `pml.component`, camelCase naming) ───────────
...
export type FusionComponent =
  // Shared primitives from types/pml
  | StackComponent
  | ContainerComponent
  | RichTextComponent
  | ImageComponent
  | IconComponent
  | FusionTouchableComponent
  | FusionAnimationContainerComponent
  | FusionReferenceContainerComponent
  | FusionExpressionComponent
  | FusionSellingUnitTileComponent
  | FusionSellingUnitMutationComponent
  | FusionStepperComponent
  | FusionAccessibilityContainerComponent
  | FusionUnavailabilityContainerComponent
  | FusionActivityIndicatorComponent
  | FusionModalComponent
  | FusionTextButtonComponent
  | FusionAccordionComponent
  | FusionPriceComponent
  | FusionSocialShareComponent
  | FusionSearchResultEntityComponent;
...
// ── Fusion page layout types (outer wrapper, not inner PML) ──────────────────
...
export type SuspenseComponent = {
  ...
  pageConfig?: { id: string; parameters?: Record<string, any> } | null;
